...
|-----|------|--------------|
| Portals / general release | **Installer** (primary) | `DiskLED_Setup_3.1.2.exe` |
| Advanced / trial | **Portable zip** | `DiskLED-3.1.2-portable.zip` |
...
1. Run `DiskLED_Setup_3.1.2.exe` (no administrator rights required)
