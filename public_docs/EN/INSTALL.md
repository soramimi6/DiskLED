...
|-----|------|--------------|
| Portals / general release | **Installer** (primary) | `DiskLED_Setup_3.0.1.exe` |
| Advanced / trial | **Portable zip** | `DiskLED-3.0.1-portable.zip` |
...
1. Run `DiskLED_Setup_3.0.1.exe` (no administrator rights required)
...
1. Extract `DiskLED-3.0.1-portable.zip` to any folder
