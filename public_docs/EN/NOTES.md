...
- **Disk / network** are aggregates. There is no way to view only a specific drive or NIC
...
- Dashboard colors follow Windows app light/dark mode. The gadget display modes (Original / Crystal / Metalic / Info Bar / Vintage) stay skin-based and do not follow OS light/dark. The Options dialog (since 3.2.0) also follows Windows light/dark
