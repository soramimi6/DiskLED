...
| 用途 | 形態 | ファイル例 |
|------|------|------------|
| 紹介サイト・一般配布 | **インストーラー**（主配布） | `DiskLED_Setup_3.1.1.exe` |
| 上級者・開発試用 | **ポータブル zip** | `DiskLED-3.1.1-portable.zip` |
...
1. `DiskLED_Setup_3.1.1.exe` を実行する（管理者権限は不要）
...
1. `DiskLED-3.1.1-portable.zip` を任意のフォルダへ展開する
