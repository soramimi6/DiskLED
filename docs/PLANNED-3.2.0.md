...
進捗（すべて `feature/3.2.0` 上・`master` 未マージ）: 項目 **1・3・4・5・7・8・9 が完了**（項目 4 は Disk/Net カードの DPI 確認のみ残る、表の「ステータス」列参照）。残るは項目 6（asset-editor、設計判断を確定済み・実装未着手）のみ。項目 2 は保留。
...
- 公開ドキュメント（`USAGE.md`/`NOTES.md`/`FEATURES.md`/`CHANGELOG.md`/`CREDITS.md` の JA+EN）にある「Info Bar はコンパクトのみ」という記述（例 [public_docs/FEATURES.md:40](../public_docs/FEATURES.md#L40)）の是正。
